...
본명조는 Pan-CJK에 포함된 오픈타입 글꼴입니다. 사용 가능한 오픈타입 글꼴과 더불어, 이 오픈소스 프로젝트는 AFDKO의 *makeotf*와 *oft2otc* 툴로 제작된 오픈타입 글꼴의 모든 소스 파일을 제공합니다.
...
변경에 대한 제안은 검토를 위해 본명조 프로젝트 관리자 [Ken Lunde 박사](mailto:lunde@adobe.com?subject=[GitHub]%20Source%20Han%20Serif)에게 보내주시기 바랍니다.
